  function buildPdfDocument(data, mode) {
    ...
    return '<!doctype html><html lang="fr"><head><meta charset="utf-8"><title>' + title + ' - MonAide-VD</title>'
      ...
      + 'h1{font-size:21px;line-height:1.08;margin:0 0 5px;color:#17293C;}'
      ...
      + '.section-title{font-size:9px;font-weight:700;letter-spacing:.12em;text-transform:uppercase;color:#17293C;margin:8px 0 5px;}'
      ...
      + '.result-index{width:18px;height:18px;border-radius:6px;background:#EEF2F7;color:#17293C;font-weight:700;display:flex;align-items:center;justify-content:center;font-size:10px;flex-shrink:0;}'
      ...
      + '.box.soft{background:#EEF2F7;border-color:#DCE6F0;}'
      + '.box-title{font-size:9px;font-weight:700;letter-spacing:.1em;text-transform:uppercase;color:#17293C;margin-bottom:4px;}'
      ...
      + '.panel h2{font-size:12px;color:#17293C;margin:0 0 4px;}'
